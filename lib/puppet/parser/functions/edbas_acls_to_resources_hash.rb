module Puppet::Parser::Functions
  newfunction(:edbas_acls_to_resources_hash, :type => :rvalue, :doc => <<-EOS
    ...
    edbas internal classes/defined resources.
    ...
    func_name = "edbas_acls_to_resources_hash()"
    ...
    acls.each do |acl|
      ...
      resources["edbas class generated rule #{id} #{index}"] = resource
    end
    resources
  end
end
